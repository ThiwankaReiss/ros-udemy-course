...
public:
    Node2() : Node("node2")
    {
        ...
        this->timer4_ = this->create_wall_timer(1000ms, std::bind(&Node2::callbackTimer4, this), cb_group_);
        this->timer5_ = this->create_wall_timer(1000ms, std::bind(&Node2::callbackTimer5, this), cb_group_);
    }
