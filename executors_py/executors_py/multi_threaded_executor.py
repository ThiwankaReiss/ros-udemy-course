...
class Node2(Node):
    def __init__(self):
        ...
        self.timer1_ = self.create_timer(1.0, self.callback_timer1, callback_group=self.cb_group)
        self.timer2_ = self.create_timer(1.0, self.callback_timer2, callback_group=self.cb_group)
